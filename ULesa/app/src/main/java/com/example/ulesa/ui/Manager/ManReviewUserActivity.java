...
public class ManReviewUserActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnupdate.setOnClickListener(v -> {
            ...
            DataBaseHelper.changeIn4(newname,newgmail,newdate,newphone,gender,this);
        });
    ...
    BroadcastReceiver receiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (intent.getAction().equals("com.example.appulesa.DATA_DONE")) {
                userModel = dataBaseHelper.getDataUser(context, id);
                if (userModel != null) layoutreview.setVisibility(View.VISIBLE);
                Log.d(TAG, "" + userModel);
                updateUI();
            }
